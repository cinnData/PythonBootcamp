...
1. Does the TripAdvisor ranking system favor the restaurants that work with The Fork or Just Eat? 

2. Create a new column containing the average rating of the reviews in English, with a `NaN` value for those restaurants witout reviews in English. How is the distribution of this average rating? How is it related to the price? And to the diets?
